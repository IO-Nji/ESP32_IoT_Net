...
This project aims to build a versatile, industrial-grade IoT Network Server device using the ESP32 platform.
The system is designed for modularity, scalability, and maintainability, with a modern embedded architecture suitable for an IoT Web Service for controlling and monitoring devices on its network.
